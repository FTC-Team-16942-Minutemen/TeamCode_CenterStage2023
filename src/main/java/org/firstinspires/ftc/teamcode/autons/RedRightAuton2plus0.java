...
public class RedRightAuton2plus0 {
    ...
    public RedRightAuton2plus0(DriveSubsystem driveSubsystem,
    ...
    public Command generate()
    {
        ...
        return new WaitCommand(0)
                ...
                .andThen(new ConditionalCommand(
                        new TrajectoryFollowerCommand(m_driveSS, "RedRight/RRGround0", 45, 45),
                        new WaitCommand(0),
                        (()-> m_vision.getLocation() == 0)))
                .andThen(new ConditionalCommand(
                        new TrajectoryFollowerCommand(m_driveSS, "RedRight/RRGround1",45,45),
                        new WaitCommand(0),
                        (()-> m_vision.getLocation() == 1)))
                .andThen(new ConditionalCommand(
                        new TrajectoryFollowerCommand(m_driveSS, "RedRight/RRGround2",45,45),
                        new WaitCommand(0),
                ...
                .andThen(m_intake.stateChangeCommand())
                .andThen(new ConditionalCommand(
                        m_driveSS.runTrajectory("RedRight/RRDeposit0",45,45),
                        new WaitCommand(0),
                        (()-> m_vision.getLocation() == 0)))
                .andThen(new ConditionalCommand(
                        m_driveSS.runTrajectory("RedRight/RRDeposit1",45,45),
                        new WaitCommand(0),
                        (()-> m_vision.getLocation() == 1)))
                .andThen(new ConditionalCommand(
                        m_driveSS.runTrajectory("RedRight/RRDeposit2",45,45),
                        new WaitCommand(0),
                        (()-> m_vision.getLocation() == 2)))
