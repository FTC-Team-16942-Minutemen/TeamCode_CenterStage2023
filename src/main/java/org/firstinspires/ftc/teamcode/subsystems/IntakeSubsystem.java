...
import org.firstinspires.ftc.robotcore.external.Telemetry;
    ...
    public class IntakeSubsystem extends SubsystemBase {
        ...
        public Command changePoseCommand(int pose) {
            return new InstantCommand(() -> this.changePose(pose));
        }
        ...
        public Command setStateCommand(String dState) {
            return new InstantCommand(() -> this.setState(dState));
        }
