...
public class DoubleCassetSubsystem extends SubsystemBase {
    ...
    public Command depositRightCommand() {
        return new InstantCommand(() -> this.depositRight());
    }

    public Command depositLeftPosition() {
        return new InstantCommand(() -> this.depositLeft());
    }

    public Command intakePoseCommand() {
        return new InstantCommand(() -> this.intakePosition());
    }
